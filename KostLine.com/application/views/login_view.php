      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="proses.php" method="post">
            ...
            <div class="form-group">
              ...
              <span class="pull-right"><a href="daftar">Register</a></span><span><a href="#">Need help?</a></span>
            </div>
          </form>
      </div>
      <div class="modal-footer">
          <div class="col-md-12">
              <a href="home"><button class="btn" data-dismiss="modal" aria-hidden="true">Back To Home</button></a>
    </div> 
      </div>
  </div>
  </div>
